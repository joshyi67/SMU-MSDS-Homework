...
author: "Joshua Yi and Grant Bourzikas"
...
ggplot(data = melted_employeeHeatMap, aes(x=X1, y=X2, fill=value)) + 
    geom_tile()
ggsave("employeeHeatMap.png",plot = ggkeySignPairs, type = png())
...
ggplot(data = melted_employeeHeatMapSig, aes(x=X1, y=X2, fill=value)) + 
  geom_tile()
ggsave("employeeHeatMapSig.png",plot = employeeHeatMapSig, type = png())
...
ggsave("ggkeySignPairs.png",plot = ggkeySignPairs, type = png())
```
